...
public class PropDocumentControlller {
...
//	@PostMapping(value = "/docUpload",method = RequestMethod.POST, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	...
	@GetMapping("/documentByCid/{cusId}")
	public PropertyDocument getDocumentByCusId(@PathVariable int cusId) {
		 PropertyDocument fetchDocumentByCid = docservice.fetchDocumentByCid(cusId);
		System.out.println(fetchDocumentByCid.getCusId());
